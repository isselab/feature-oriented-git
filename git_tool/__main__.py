...
from git_tool.ci.subcommands.feature_add_from_staged import (
    features_from_staging_area,
)
...
app.command(name="blame", help="Display features associated with file lines.")(
    feature_blame
)
app.command(
    name="commit",
...
app.command(
    name="commit-msg",
    help="Generate feature information for the commit message.",
)(feature_commit_msg)
app.add_typer(
    feature_commits,
    name="commits",
    help="Use with the subcommand 'list' or 'missing' to show commits with or without associated features.",
)
app.command(name="info", help="Show information of a specific feature.")(
    inspect_feature
)
app.command(
    name="info-all", help="List all available features in the project."
)(all_feature_info)
app.command(
    name="pre-commit",
    help="Check if all staged changes are properly associated with features.",
)(feature_pre_commit)
app.command(
    name="status",
    help="Display unstaged and staged changes with associated features.",
)(feature_status)
